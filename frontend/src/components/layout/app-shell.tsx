...
const mainNavItems: MenuProps["items"] = [
  ...
  { key: "/platforms/xhs/accounts", icon: <SafetyCertificateOutlined />, label: "小红书账号" },
  ...
  { key: "/platforms/xhs/analytics", icon: <BarChartOutlined />, label: "小红书数据洞察" },
  ...
  { key: "/platforms/xhs/drafts", icon: <FileTextOutlined />, label: "小红书草稿" },
  { key: "/platforms/xhs/publish", icon: <SendOutlined />, label: "小红书发布" },
