...
export const platformSectionRegistry: Record<string, PlatformSectionConfig[]> = {
  "xhs": [
    ...
    { key: "keywords", path: "/platforms/xhs/keywords", icon: <KeyOutlined />, label: "小红书关键词组", title: "小红书关键词组", description: "管理关键词组与灰豚热词发现。", status: "available" },
    { key: "crawler", path: "/platforms/xhs/crawler", icon: <CloudDownloadOutlined />, label: "小红书数据抓取", title: "小红书数据抓取", description: "执行数据抓取、入库和采集记录管理。", status: "available" },
