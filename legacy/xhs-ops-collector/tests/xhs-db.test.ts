...
describe('XHS database repository', () => {
  ...
  it('keeps the fullest stored detail row when resuming existing XHS details', () => {
    const richRunId = repository.createXhsSearchRun({
      source: 'manual_keyword',
      sourceRunId: null,
      keyword: '护肤',
      sorts: ['latest'],
    ...
    repository.upsertXhsSearchNotes(richRunId, [{
      keyword: '护肤',
      sortKey: 'latest',
      sortLabel: '最新',
      rankIndex: 1,
      feedId: 'feed-a',
      xsecToken: 'token-old',
      searchResultUrl: 'https://www.xiaohongshu.com/search_result/feed-a?xsec_token=token-old',
      exploreUrl: 'https://www.xiaohongshu.com/explore/feed-a?xsec_token=token-old',
      title: '旧标题完整',
      authorName: '作者A',
      authorProfileUrl: null,
      coverUrl: null,
      ...
      sourceComments: [{ contentText: '旧评论', authorName: '用户X', likeText: '2', rawText: '用户X\n旧评论\n2' }],
      mediaSources: [{ kind: 'image', url: 'https://example.com/old.jpg', posterUrl: null, altText: '旧封面' }],
    ...
    repository.upsertXhsSearchNotes(sparseRunId, [{
      keyword: '护肤',
      sortKey: 'latest',
      sortLabel: '最新',
      rankIndex: 1,
      feedId: 'feed-a',
      xsecToken: 'token-new',
      searchResultUrl: 'https://www.xiaohongshu.com/search_result/feed-a?xsec_token=token-new',
      exploreUrl: null,
      title: '新标题稀疏',
      authorName: '作者A',
      authorProfileUrl: null,
    ...
    const freshRows = repository.applyExistingXhsDetails([
      {
        keyword: '护肤',
        sortKey: 'latest',
        sortLabel: '最新',
        ...
        searchResultUrl: 'https://www.xiaohongshu.com/search_result/feed-a?xsec_token=fresh-token',
        exploreUrl: null,
        title: '新标题稀疏',
        authorName: '作者A',
        authorProfileUrl: null,
